      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You\'ve logged out successfully');
              window.setTimeout(function () {
...
},{"./alerts.js":"alerts.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51LWe2YFbTeanWxDimFQ2XqoeiBxTifOfoRiFM2FLMLJH9EY3JaL9YDojljebRVZwK5P8hwHwcTcidhLl7pKntO9f00R9Ikzy79');
...
if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // displayMap(locations)
}
...
},{"./login.js":"login.js","./mapbox.js":"mapbox.js","./updateSettings.js":"updateSettings.js","./stripe.js":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
